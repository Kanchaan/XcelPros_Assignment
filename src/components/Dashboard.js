...
const Dashboard = (props) => {
  ...
  const HolderEditor = (props) => {
    return inputTextEditor(props, "Holder");
  };
        ...
        <div>
          ...
          <h1>My Things To Do</h1>
            ...
            footer={footer}>
                ...
                <Column columnKey="Holder" field="Holder" header="Holder" editor={HolderEditor}/>
